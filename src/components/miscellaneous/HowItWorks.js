                  ...
                  <div className="container">
                      <div className="tf_ventures ">
                        ...
                        <div className="col-md-6">
                          <LazyLoadImage
                            alt={"hiringImg"}
                            src={hiringImg} // use normal <img> attributes as props
                      ...
                      <div className="tf_ventures">
                        <div className="col-md-6">
                          <LazyLoadImage
                            alt={"hiring1Img"}
                            src={hiring1Img} // use normal <img> attributes as props
                      ...
                      <div className="tf_ventures">
                        ...
                        <div className="col-md-6">
                          <LazyLoadImage
                            alt={"hiring2Img"}
                            src={hiring2Img} // use normal <img> attributes as props
                            className="responsive-image how-it-works-page-image"
                          />
                        </div>
                      </div>
                      <div className="clearfix"></div>
                      ...
                      <div className="tf_ventures">
                        <div className="col-md-6">
                          <LazyLoadImage
                            alt={"hiring3Img"}
                            src={hiring3Img} // use normal <img> attributes as props
                            className="responsive-image how-it-works-page-image"
                          />
                        </div>
                        <div className="col-md-6">
                  ...
                  <div className="container">
                    <div className="tf_ventures">
                      ...
                      <div className="col-md-6">
                        <LazyLoadImage
                            alt={"freelancingImg"}
                            src={freelancingImg} // use normal <img> attributes as props
                            className="responsive-image how-it-works-page-image"
                          />
                      </div>
                    </div>
                    ...
                    <div className="tf_ventures">
                      <div className="col-md-6">
                        <LazyLoadImage
                            alt={"freelancing1Img"}
                            src={freelancing1Img} // use normal <img> attributes as props
                            className="responsive-image how-it-works-page-image"
                          />
                      </div>
                      <div className="col-md-6">
                    ...
                    <div className="tf_ventures">
                      ...
                      <div className="col-md-6">
                        ...
                        <LazyLoadImage
                            alt={"freelancing2Img"}
                            src={freelancing2Img} // use normal <img> attributes as props
                            className="responsive-image how-it-works-page-image"
                          />
                      </div>
                    </div>
                    ...
                    <div className="tf_ventures">
                      <div className="col-md-6">
                        ...
                        <LazyLoadImage
                            alt={"freelancing3Img"}
                            src={freelancing3Img} // use normal <img> attributes as props
                            className="responsive-image how-it-works-page-image"
                          />
                      </div>
                      <div className="col-md-6">
