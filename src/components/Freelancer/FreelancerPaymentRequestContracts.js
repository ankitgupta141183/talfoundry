...
export default class FreelancerPaymentRequestContracts extends Component {
  ...
  render() {
    const { paymentRequestContracts } = this.props
              ...
              <div className="col-md-12 p-0">
                <div className="p-4 box-shadow bg-white">
                  ...
                  <table className="table">
                    <tbody>
                      {!isEmpty(paymentRequestContracts) ? (
                        paymentRequestContracts.map((contract) => {
                          return (
