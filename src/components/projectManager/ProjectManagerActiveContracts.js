...
class ProjectManagerActiveContracts extends Component {
              ...
              {!isEmpty(activeContracts) ?
                            ...
                            <td>
                              <div className="">
                                <p className="project-manager-payment-requested">
                                  ...
                                  {(!isEmpty(contract.status) && ['Payment Requested', 'Payment Approved', 'Changes Requested'].includes(contract.status))
                                    ? `- ${contract.status}`
                                    : null}
                                </p>
                              </div>
                ...
                : !this.props.isLoading && (
                  <div className="tf_all_aws tf_my_aws noJobsFound">
                    ...
                    <p className="text-center all-job-posting-center">No Active Contract Found.</p>
                  </div>
                )}
...
export default connect(mapStateToProps, mapDispatchToProps)(ProjectManagerActiveContracts)
