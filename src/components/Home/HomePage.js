...
class HomePage extends Component {
  ...
  render() {
    let { speciality, value, searchItem, exploreSuggestid } = this.state
        ...
        <div className="wraper">
          <div className="header_top landing-page-not-down-menu">
            ...
            <div className="header">
              ...
              <div className="tf_we">
                <div className="container">
                  <div className="mn_welcome landing_page_btn">
        ...
        <div className="mn_services home-page-cloud-expert-section">
          ...
          <div className="cloud_expert_home_page category_circle">
            <div className="container">
              ...
              <div className="row">
                <div className="col-lg-6 home-light-bg">
                ...
                <div className="col-lg-6">
                  ...
                  <div class="text-center mn_learnmore">
                    <button class="btn_want_to_work mr-20 home-explore-by-skill-btn" id="Explore_by_Role" onClick={(e) => this.handleExploreSuggest(e)} >Explore by Role</button>
                    <button class="btn_want_to_work home-explore-by-skill-btn" id="Explore_by_Skill" onClick={(e) => this.handleExploreSuggest(e)} >Explore by Skill</button>
                  </div>
          ...
          <div className="cloud_expert_home_page pt-0">
                      ...
                      <div id="home" className="tab-pane fade in active">
                        <div className="row vt-center">
                          <div className="col-lg-5 text-center">
                            ...
                            <h3><span className="txt-26-primary">1 Post a job</span></h3>
                      ...
                      <div id="menu1" className="tab-pane fade">
                        ...
                        <div className="row vt-center">
                          <div className="col-lg-5 text-center">
                            ...
                            <h3><span className="txt-26-primary">1 Create your profile</span> </h3>
                            <div className="bs-wizard-info ">
            ...
            <div className="row What_Type_Of_Work_Section text-center">
              <div className="container What_Type_Of_Work_box">
                <div className="col-md-5 px-0">
                  <div className="What_Type_Of_Work_Box text-left">
                    <h3 className="what-type-of-work-heading ">Find the expert you need, right now!</h3>
                    ...
                    <p className="no-upfront-payment">No upfront payment, no hidden fees.</p>
                  </div>
                </div>
            ...
            {/* Start Section How It Works */}
            <div className="row whyChooseTalFoundrySection" id="mn_project">
              ...
              <div className="container">
                <div className="row">
                  <div className="col-md-12 pt-3 pb-3">
                    <div class="mn_project">
                      <h3 class="explore_ces How_It_Works_heading">Choose the <span className="txt-36-primary">right job</span> for you</h3>
                      <div className="row">
